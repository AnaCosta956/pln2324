...
file = open('TP1\Minidicionario_de_Cardiologista\cardiologia.xml', 'r', encoding="utf8")
...
file = open('TP1\Minidicionario_de_Cardiologista\dic_traduc.json', 'w', encoding='utf-8')
