...
f = open("TP1\glossario_medico\glossario\glossario.xml", "r", encoding="utf-8")
texto = f.read()
...
cfile = open("TP1\glossario_medico\categorias\categorias.json", "r", encoding="utf8")
...
file_out = open("TP1\glossario_medico\glossario\glossario_limpo.xml", "w", encoding="utf8")
file_out.write(texto)
file_out.close()


file_out = open("TP1\glossario_medico\glossario\glossario.json", "w", encoding="utf8")
