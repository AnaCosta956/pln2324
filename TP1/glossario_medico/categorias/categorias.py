...
f = open("TP1\glossario_medico\categorias\categorias.xml", "r", encoding="utf-8")
texto = f.read()
...
file_categorias = open("TP1\glossario_medico\misc\misc.json", "r", encoding="utf-8")
...
file_out = open("TP1\glossario_medico\categorias\categorias.json", "w", encoding="utf-8")
